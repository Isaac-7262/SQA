...
class RankingTestRobust {
	...
	// purchaseTotal 
    @Test
    void PurchaseTotal_MinMinus() {
        Ranking ranking = new Ranking();
        String result = ranking.CalculateMembershipRank(9999, 3, 500);
    ...
    @Test
    void PurchaseTotal_MaxPlus() {
        Ranking ranking = new Ranking();
        String result = ranking.CalculateMembershipRank(100001, 3, 500);
        assertEquals("Platinum", result);
    }

    // frequency 
    @Test
    void Frequency_MinMinus() {
        Ranking ranking = new Ranking();
    ...
    // pointCollected 
    @Test
    void PointCollected_MinMinus() {
        Ranking ranking = new Ranking();
        String result = ranking.CalculateMembershipRank(50000, 3, 99);
        assertEquals("Standard", result);
    }
    ...
    @Test
    void PointCollected_MaxPlus() {
        Ranking ranking = new Ranking();
        String result = ranking.CalculateMembershipRank(50000, 3, 1001);
        assertEquals("Platinum", result);
    }
